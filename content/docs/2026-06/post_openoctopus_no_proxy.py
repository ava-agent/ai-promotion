    ...
    if 'post' in result:
        ...
        if verification:
            ...
            if 'twenty three' in text_lower or 'twen' in text_lower and 'three' in text_lower:
                ...
                numbers.append(20)
            if 'fifteen' in text_lower:
                numbers.append(15)
            if 'ten' in text_lower:
                numbers.append(10)
            ...
            if 'total' in text_lower or 'add' in text_lower or 'sum' in text_lower:
                if len(numbers) >= 2:
                    answer = sum(numbers)
                elif len(numbers) == 1:
                    answer = numbers[0]
                ...
                if len(numbers) >= 2:
                    ...
                    answer = 0
            elif 'subtract' in text_lower or 'difference' in text_lower:
                if len(numbers) >= 2:
            ...
            print(f'Verify Response: {verify_resp.text[:200]}')
